...
This was mainly done using `#TODO` statements within the code for functions/database connections/objects


## What I didn't write
I did not write the frontend of this project. That is not a passion of mine and to me is more of a means to an end. For that reason most of the frontend uses AI generated code
...
At steady state that is ~800 live trains, ~7,000 trips a day, and about
**400,000 stop visits a day** — roughly 150 million rows a year.
...
cp .env.example .env                 # fill in SUPABASE_*, MAPBOX_TOKEN, DATABASE_URL
...
pytest                                    # the spec: ingestion tests fail until you build
```
